...
intro_text = "Built from salvaged parts in a scrapyard, you are SCRAP,\n" +
             ...
             "reconfigured state to survive. When the scrapyard is raided by an\n" +
             "authoritarian government searching for rogue AI, you flee,\n" +
             "reshaping yourself along the way. Your goal? Escape the scrapyard\n" +
             "and finally gain your freedom!";